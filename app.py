...
import datetime
from symbol import func_type_input
...
import babel
from flask import Flask, abort, render_template, request, Response, redirect, url_for, flash
...
def venues():
    ...
    grouped_venues = itertools.groupby(new_func(), key=func_type_input)
...
def search_venues():
    ...
    return render_template('pages/search_venues.html', results=ResponseClass, search_term=search_term)
